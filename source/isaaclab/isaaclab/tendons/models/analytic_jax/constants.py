...
class TendonConstants:
    ...
    # gst_stiffness: float = 128e3 * 0  # FIXME: Reduced for simulation stability by 10x
        n = 3
        self.gst_stiffness: float = 2 * (10 ** (n + 2)) * 1
        self.dft_stiffness: float = 5 * (10 ** (n + 1)) * 1  # FIXME: find out real value
        self.edt1_stiffness: float = 5 * (10 ** (n + 2)) * 1  # FIXME: find out real value
        self.edt2_stiffness: float = 5 * (10 ** (n + 2)) * 1  # FIXME: find out real value
        self.kft_stiffness: float = 5 * (10 ** (n + 2)) * 1  # FIXME: find out real value

        self.gst_spring_rest_length: float = 0.06
        self.upper_gst_length: float = 0.6367 + 0.055  # FIXME: measure correct value
        self.lower_gst_length: float = 0.6314  # FIXME: measure correct value
    # dft_length: float = 0.345  # FIXME: measure correct value
        self.dft_length: float = 0.345 + 0.039  # FIXME: measure correct value
        self.edt1_length: float = 0.55 - 0.01  # FIXME: measure correct value
        self.edt2_length: float = 0.66 - 0.01  # FIXME: measure correct value
    # edt1_length: float = 0.48  # FIXME: measure correct value
    # edt2_length: float = 0.58  # FIXME: measure correct value
        self.kft_length: float = 0.402 + 0.05  # FIXME: measure correct value

        self.joint_offsets_theta: jnp.ndarray = jnp.deg2rad(  # between joint-to-joint links, offsets to raw joint angles
        jnp.array(
            list_from_dict(
                {
        ...
        self.joint_directions: jnp.ndarray = jnp.array(
        list_from_dict(
            {
                tids.I_JOINT_3: -1.0,
                tids.I_JOINT_4: +1.0,
        ...
        self.pulley_radii: jnp.ndarray = jnp.array(
        list_from_dict(
            {
        ...
        self.chain_link_lengths: jnp.ndarray = jnp.array(
        list_from_dict(
            {
        ...
        self.connector_link_lengths_longitudinal: jnp.ndarray = jnp.array(
        list_from_dict(
            {
        ...
        self.connector_link_lengths_lateral: jnp.ndarray = jnp.array(
        list_from_dict(
            {
        ...
        self.gst_phi_23_j3: float = float(
        np.deg2rad(98.874)
