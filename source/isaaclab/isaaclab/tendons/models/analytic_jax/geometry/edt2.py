...
class EDT2DeltaCoreOutput(NamedTuple):
    delta_l: jnp.ndarray
    EDT2_L_s: jnp.ndarray
    EDT2_state_A: jnp.ndarray
    EDT2_state_B: jnp.ndarray
    EDT2_state_C: jnp.ndarray
    EDT2_state_D: jnp.ndarray
    EDT2_L_s_A: jnp.ndarray
    EDT2_L_s_B: jnp.ndarray
    EDT2_L_s_C: jnp.ndarray
    EDT2_L_s_D: jnp.ndarray
...
def compute_edt2_delta_l_core(
    ...
    EDT2_L_s = jnp.where(
        EDT2_state_A,
        EDT2_L_s_A,
        jnp.where(EDT2_state_B, EDT2_L_s_B, jnp.where(EDT2_state_C, EDT2_L_s_C, EDT2_L_s_D)),
    )
