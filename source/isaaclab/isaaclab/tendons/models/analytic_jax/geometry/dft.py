...
class DFTDeltaCoreOutput(NamedTuple):
    delta_l: jnp.ndarray
    DFT_L_s: jnp.ndarray
    DFT_state_A: jnp.ndarray
    DFT_state_B: jnp.ndarray
    DFT_state_C: jnp.ndarray
    DFT_state_D: jnp.ndarray
    DFT_L_s_A: jnp.ndarray
    DFT_L_s_B: jnp.ndarray
    DFT_L_s_C: jnp.ndarray
    DFT_L_s_D: jnp.ndarray
    DFT_q5_D: jnp.ndarray
    DFT_q6_B: jnp.ndarray
...
def compute_dft_delta_l_core(
    ...
    DFT_L_s_C = jnp.sqrt(geom.DFT_l_c7_squared)
