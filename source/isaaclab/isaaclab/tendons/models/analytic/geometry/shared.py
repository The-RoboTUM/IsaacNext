...
def compute_shared_tendon_geometry(coords: TendonCoordinates, tendon_data: TendonDataJIT) -> SharedTendonGeometry:
    ...
    GST_h5_B = tendon_data.pulley_radii[:, tids.I_RADIUS_GST_4prime] - tendon_data.link_lengths[:, tids.I_LINK_4prime5] * torch.cos(GST_phi_4prime_B)
    ...
    GST_h5_C = tendon_data.pulley_radii[:, tids.I_RADIUS_GST_4prime] - tendon_data.link_lengths[:, tids.I_LINK_4prime5] * torch.cos(GST_phi_4prime_C)
    GST_h6_C = tendon_data.pulley_radii[:, tids.I_RADIUS_GST_4prime] - GST_x_4prime6 * torch.cos(GST_phi_4prime_c + GST_phi_4prime_d)
    ...
    GST_h6_D = tendon_data.pulley_radii[:, tids.I_RADIUS_GST_5] - tendon_data.link_lengths[:, tids.I_LINK_56] * torch.cos(GST_phi_5_D)
    ...
    # The same squared distance is used by EDT2 state B and state C.
    ...
    EDT2_phi_6_d = angle_from_sws(EDT2_x_6c, tendon_data.link_lengths[:, tids.I_LINK_EDT2_C4], EDT2_thetahat_4_b)
    ...
    EDT2_h5_B = tendon_data.pulley_radii[:, tids.I_RADIUS_EDT2_6] - tendon_data.link_lengths[:, tids.I_LINK_56] * torch.cos(EDT2_phi_6_B)

    EDT2_l_46_j_squared = EDT2_x_64prime_squared
    EDT2_l_46_j = EDT2_x_64prime
    ...
    EDT2_phi_4_b = angle_from_sws(tendon_data.link_lengths[:, tids.I_LINK_EDT2_C4], EDT2_l_46_j, EDT2_thetatilde_4)
    ...
    EDT2_q5_D = 2 * torch.pi - EDT2_phi_56 - thetas[:, tids.I_THETA_EDT2_5] - EDT2_thetahat_5_a - EDT2_phi_45_A
